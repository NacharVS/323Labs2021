...
namespace Bank1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            db.users.Add(new Person("1", "Иванов Иван Иванович", "323",balance1));
            db.users.Add(new Person("2", "Жаров Андрей Артемьевич", "323", balance2));
            db.users.Add(new Person("3", "Воронцов Тимофей Алексеевич", "323", balance3));
            db.users.Add(new Person("4", "Скворцова Александра Александровна", "323", balance4));
            db.users.Add(new Person("5", "Калашникова Яна Руслановна", "323", balance5));
